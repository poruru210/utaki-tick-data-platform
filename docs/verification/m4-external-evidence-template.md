...
object、MT5 data、credential、rclone configはrepository外のoperator-controlled
...
- credential value、token、endpoint、bucket名、account ID、rclone config本文、local
...
toolchain:
  ...
  go: "<go version>"
  rclone: "<version and verified binary digest>"
