...
- [x] local環境ではgccとclangが存在しないためrace testは実行せず、Windows CIのpush run `29380124589`とPR run `29380126328`でrace検証を成功させました。
...
- [x] PR #3は`0b14bfa`をheadとしてopen、clean、mergeableです。
...
M2R-4のreal-R2 smokeは必要なopt-in条件がlocal環境にないためskipし、GitHub Actionsのcheck push run `29380124381`、check PR run `29380126333`、Windows race push run `29380124589`、Windows race PR run `29380126328`は全て成功しました。
...
M2R-3のrace testはgccとclangがlocalに存在しないため実行せず、M2R-4のWindows race workflowで対象packageをまとめて実行し、push run `29380124589`とPR run `29380126328`を成功させました。
...
local環境にgccとclangがないためrace testは実施しませんでしたが、Windows race workflowのpush run `29380124589`とPR run `29380126328`で解消しました。
...
push run `29380124589`とPR run `29380126328`でこの検証を成功させました。
...
M2R-4のrace検証はmise exec -- go test -race ./internal/ingest ./internal/wal ./internal/archive ./internal/r2 ./internal/delivery ./internal/catalogをWindows CIで実行し、push run `29380124589`とPR run `29380126328`を成功させました。
